...
describe('CounterState', () => {
  ...
  describe('reset', () => {
    it('should reset the counter state to initial value', () => {
      ...
      expect(modifiedState.state.counter.toBe(initialState.counter));
  ...
  describe('requestRandomNumber', () => {
    ...
    it('should generate a random number and dispatch it', async () => {
      ...
      expect(nextState.counter.get('value')).toBe(action.payload);
      expect(nextState.counter.get('loading')).toBe(false);
    });
  });
});
